...
Open a [GitHub Issue](https://github.com/openhydra-ai/openhydra/issues/new?template=bug_report.md) and include:
...
Open a [GitHub Issue](https://github.com/openhydra-ai/openhydra/issues/new?template=feature_request.md) with:
...
| Docs site | `pip install -e ".[docs]"` | MkDocs Material + mkdocstrings |
...
See [LICENSE](https://github.com/openhydra-ai/openhydra/blob/main/LICENSE) for the full dual-license structure.
...
Questions? Join the discussion in [GitHub Discussions](https://github.com/openhydra-ai/openhydra/discussions) or open an issue.
