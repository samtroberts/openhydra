...
//! * [`openai`] — any OpenAI-compatible server (vLLM, LM Studio, Exo, llama.cpp `--api`,
//!   LocalAI). One adapter for the whole family; thinner metadata, so models are
//!   advertised by their engine id (uncanonicalised).
